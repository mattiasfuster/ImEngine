...
#ifndef IMENGINE_ENGINE_API_H
#define IMENGINE_ENGINE_API_H

#ifdef IMENGINE_ENGINE_STATIC_DEFINE
#  define IMENGINE_ENGINE_API
#  define IMENGINE_ENGINE_NO_EXPORT
#else
#  ifndef IMENGINE_ENGINE_API
...
#  define IMENGINE_ENGINE_DEPRECATED_EXPORT IMENGINE_ENGINE_API IMENGINE_ENGINE_DEPRECATED
#endif
